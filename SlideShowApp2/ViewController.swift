...
class ViewController: UIViewController {
    ...
    let images = [UIImage(named: "arikabe.jpeg"), UIImage(named: "madoka.jpeg"),UIImage(named: "wakaru.jpeg"), UIImage(named: "34635.jpeg")]
    ...
    var imageArray = [
        ...
        UIImage(named: "madoka.jpeg"),
        UIImage(named: "wakaru.jpeg"),
        UIImage(named: "34635.jpeg")
    ]
